...
interface Props {
    ...
    //Method
    onSummit : (productLike: Partial<Product> & {files?:File[]}
...
export const ProductForm = ({title,subTitle,product, isPending,onSummit, }:Props) => {
 ...
 const inputRef = useRef<HTMLInputElement>(null)
    ...
    //   const selectedImagenes = watch('images');
   //    console.log(selectedImagenes)
  ...
  return (
                    ...
                    </div>
    {
                        errors.price &&(
                            ...
                            <p className="text-red-500">el precio el precio debe ser mayor a 0</p>
                        )
                    }
                    <div>
                      <label className="block text-sm font-medium text-slate-700 mb-2">
                      ...
                      />
                        ...
                        errors.stock &&(
                            ...
                            <p className="text-red-500">el stock el precio debe ser mayor a 0</p>
                        )
                    }
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">
                  ...
                  </div>
   {
                        errors.slug &&(
                            ...
                            <p className="text-red-500">{errors.slug.message || 'el slug es requerido'}</p>
                        )
                    }
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">
                    ...
                    />
                  </div>
                     {
                        errors.description &&(
                            ...
                            <p className="text-red-500">{'la descripcion es requerido'}</p>
                        )
                    }
                      ...
                      <span
                        ...
                        className=
                           {cn( "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 border border-blue-200",
                            {
                                hidden : !selectedSize.includes(size),
                            }
                  ...
                  <div className="grid grid-cols-2 gap-3">
                   {
                    ...
                    files.length === 0 && (<div className="text-red-500">No hay archivos por cargar</div>)
                   } */}
