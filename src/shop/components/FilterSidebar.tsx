      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          sizes.map((size) => (
            <Button
              key={size.id}
              variant ={currentSizes.includes(size.id)
                 ? 'default' : 'outline' }
              // variant="outline"
      ...
      <div className="space-y-4">
        ...
        <RadioGroup defaultValue={currentPrice} className="space-y-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            onClick={()=>handlePriceChanged("50-100")} id="price2" />
          ...
          <div className="flex items-center space-x-2">
            ...
            onClick={()=>handlePriceChanged("100-200" )}  id="price3" />
          ...
          <div className="flex items-center space-x-2">
            ...
            onClick={()=>handlePriceChanged("200+" )} id="price4" />
